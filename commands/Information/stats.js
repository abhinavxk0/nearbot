    ...
    async execute(client, message, args, Discord) {
        ...
        let m = await message.lineReply(
            new Discord.MessageEmbed()
                ...
                .setColor(hexColor)
                .setDescription(`[\`Invite Nearbot\`](${`https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=8`})  ·  [\`Support Server\`](https://discord.gg/3h5ajxffkw)  ·  [\`Bot Developer\`](https://discords.com/bio/p/xaviervv)`)
                .addFields(
                    {
                        name: 'Ping',
